...
module.exports = {
  name: "invite",
  description: "Пригласи меня на сервер",
  usage: "",
  permissions: {
  ...
  run: async (client, message, args, { GuildDB }) => {
    let embed = new MessageEmbed()
      ...
      .setColor("BLUE")
      .setDescription(
        `Ты можешь пригласить меня нажав [сюда](https://discord.com/oauth2/authorize?client_id=${
  ...
  SlashCommand: {
    ...
    run: async (client, interaction, args, { GuildDB }) => {
      let embed = new MessageEmbed()
        .setAuthor(
          "Пригласи " + client.user.tag + " на свой сервер",
          client.user.displayAvatarURL()
        )
        .setColor("BLUE")
        .setDescription(
