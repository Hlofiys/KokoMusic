...
module.exports = {
  name: "move",
  description: "Передвигает песню в определенную позицию",
  usage: "",
  permissions: {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    if (!args[0] || !args[1])
      return client.sendTime(message.channel, "❌ | **Неверные аргументы**");
  ...
  SlashCommand: {
    options: [
      ...
      },
      {
        ...
        type: 4,
        required: true,
        description: "Передвигает выбранный трек на определенную позицию",
      },
    ],
    /**
     *
