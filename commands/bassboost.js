...
module.exports = {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    return client.sendTime(
      message.channel,
      `✅ | **Уровель бассбуста сменен на** \`${level}\``
    );
  },
  SlashCommand: {
    options: [
      {
        name: "level",
        description: `Укажи уровень бассбуста. Доступные уровни: low, medium, high, или none`,
        value: "[level]",
        type: 3,
        required: true,
      },
    ...
    run: async (client, interaction, args, { GuildDB }) => {
      ...
      return client.sendTime(
        interaction,
        `✅ | **Поставил уровень бассбуста на** \`${level}\``
      );
    },
  },
};
