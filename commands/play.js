...
module.exports = {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    let Searching = await message.channel.send(":mag_right: Ищу...");
    ...
    try {
      if (SearchString.match(client.Lavasfy.spotifyPattern)) {
        ...
        if (Searched.loadType === "PLAYLIST_LOADED") {
          ...
          //SongAddedEmbed.addField("Длительность плейлиста", `\`${prettyMilliseconds(Searched.tracks, { colonNotation: true })}\``, false)
          ...
          //SongAddedEmbed.addField("Длительность", `\`${prettyMilliseconds(Searched.tracks[0].length, { colonNotation: true })}\``, true);
    ...
    options: [
      {
        ...
        type: 3,
        required: true,
        description: "Воспроизводит музыку в войсе",
      },
    ],
    /**
     *
